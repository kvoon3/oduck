...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'btn-surface': 'bg-neutral-400 text-neutral-950 dark:(bg-neutral-700/50 text-neutral-50)',
    'btn-primary': 'btn-base btn-surface',
    'btn-secondary': 'btn-base btn-surface',
    'btn-danger': 'btn-base bg-neutral-400 text-[#8a0018] dark:(bg-neutral-700/50 text-[#ff9aaa])',
    'btn-icon': 'btn flex items-center justify-center rounded-md bg-neutral-400 p-2 text-neutral-950 op-75 transition duration-150 hover:op-100 focus-visible:(outline-none ring-2 ring-neutral-500/45 ring-offset-2 ring-offset-white) dark:(bg-neutral-700/50 text-neutral-50 focus-visible:ring-offset-[#101010])',
    'btn-close': 'btn flex items-center justify-center w-8 h-8 rounded-md bg-neutral-400 text-neutral-950 text-xl leading-none op-75 transition duration-150 hover:op-100 focus-visible:(outline-none ring-2 ring-neutral-500/45 ring-offset-2 ring-offset-white) dark:(bg-neutral-700/50 text-neutral-50 focus-visible:ring-offset-[#101010])',
    // Links
